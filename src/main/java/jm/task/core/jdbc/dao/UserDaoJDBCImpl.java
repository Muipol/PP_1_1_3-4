...
public class UserDaoJDBCImpl implements UserDao {
    ...
    public void createUsersTable() {
        try (Statement statement = CONNECTION.createStatement()) {
            ...
            e.printStackTrace();
            System.out.println("Не удалось создать таблицу, ошибка работы с БД");
        }
    }
    ...
    public void dropUsersTable() {
        try (Statement statement = CONNECTION.createStatement()) {
            ...
            e.printStackTrace();
            System.out.println("Не удалось удалить таблицу, ошибка работы с БД");
        }
    }
    ...
    public void saveUser(String name, String lastName, byte age) {
        try (PreparedStatement preparedStatement = CONNECTION.prepareStatement(SAVE_USER_SQL)) {
            ...
            e.printStackTrace();
            System.out.println("Не удалось добавить пользователя в таблицу, ошибка работы с БД");
        }
    }
    ...
    public void removeUserById(long id) {
        try (PreparedStatement preparedStatement = CONNECTION.prepareStatement(REMOVE_USER_BY_ID_SQL)) {
            ...
            e.printStackTrace();
            System.out.println("Не удалось удалить пользователя, ошибка работы с БД");
        }
    }
    ...
    public List<User> getAllUsers() {
        ...
        try (Statement statement = CONNECTION.createStatement()) {
            ...
            e.printStackTrace();
            System.out.println("Не удалось получить всех пользователей, ошибка работы с БД");
        }
        return null;
    }
    ...
    public void cleanUsersTable() {
        try (Statement statement = CONNECTION.createStatement()) {
            ...
            e.printStackTrace();
            System.out.println("Не удалось очистить очистить таблицу, ошибка работы с БД");
        }
    }
}
